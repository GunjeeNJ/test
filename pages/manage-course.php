        ...
        <div class="app-main__inner">
            ...
            <div class="col-md-12">
                <div class="main-card mb-3 card">
                    <div class="card-header">Хичээлүүдийн жагсаалт
                    </div>
                    <div class="table-responsive">
                        <table class="align-middle mb-0 table table-borderless table-striped table-hover" id="tableList">
                            <thead>
                            <tr>
                                <th class="text-left pl-4">Хичээлийн нэр</th>
                                <th class="text-center" width="20%">Төлөв</th>
                            </tr>
                            </thead>
                            <tbody>
                              <?php 
                                ...
                                { ?>
                                    <tr>
                                      <td colspan="2">
                                        <h3 class="p-3">Хичээл байхгүй байна.</h3>
                                      </td>
                                    </tr>
                                <?php }
                               ?>
