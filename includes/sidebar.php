    ...
    <div class="app-header__menu">
        ...
        <div class="app-sidebar__inner">
            <ul class="vertical-nav-menu">
                ...
                <li class="app-sidebar__heading">Ажиллах боломжтой шалгалтууд</li>
                <li>
                <a href="#">
                ...
                <ul >
                    <?php 
                        ...
                        { ?>
                            <a href="#">
                                <i class="metismenu-icon"></i>Ажиллах шалгалт байхгүй байна
                            </a>
                        <?php }
                     ?>
                 ...
                 <li class="app-sidebar__heading">Ажилласан шалгалтууд</li>
                <li>
                  <?php 
                    ...
                    { ?>
                        <a href="#" class="pl-3">Шалгалт ажиллаагүй байна</a>
                    <?php }
                ...
                <li class="app-sidebar__heading">Санал хүсэлт</li>
                <li>
