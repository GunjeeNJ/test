   ...
   <form class="refreshFrm" id="addFeebacks" method="post">
     <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Санал хүсэлт илгээх</h5>
      ...
      <div class="modal-body">
        <div class="col-md-12">
          <div class="form-group">
            <label>Санал хүсэлт илгээх</label><br>
            <?php 
            ...
            <input type="radio" name="asMe" value="Anonymous"> Бүртгэлгүй хаягаар сонгох
